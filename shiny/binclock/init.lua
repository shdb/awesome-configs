...
local function DEC_BIN(IN) -- thanx to Lostgallifreyan (http://lua-users.org/lists/lua-l/2004-09/msg00054.html)
...
local function paintdot(val,shift,limit) -- paint number as dots with shift from left side
...
local function drawclock() -- get time and send digits to paintdot()
